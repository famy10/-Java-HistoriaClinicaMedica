...
public class TablaDetallada {
    JButton BtnModificar = new JButton("CONSULTAR"); 
     
    DefaultTableModel objtabla;
    TableColumn columna;
    
    String [] TitCol = {"Patología" , "Consultar" , "Profesional médico" ,"Fecha de la visita" };
    String [][] Filas = { };
    ...
    public void ver_tabla(JTable tabla,int leg, String esp) {
        legajo=leg;
        especialidad=esp;
    ...
    public DefaultTableModel ConsultarHistoria(int legajo ) {
        ...
        System.out.println(te.getEspecialidad());
        String str_sql="SELECT enfermedad, medico, feAtención FROM fichamedica where Paciente_legajo = '"+ legajo +"' and Especilidad = '"+ especialidad +"';";
         try {
            con = new Conexion();
...
//                this.setFechaSql(java.sql.Date.valueOf(rs.getString(2)));
         ...
         // new Object [][] {{"acne",BtnModificar,"pedro","30/10/1982"},{"acne",BtnModificar,"juan","30/10/1982"},{"acne",BtnModificar,"rosa","30/10/1982"},{"acne",BtnModificar,"maria","30/10/1982"}}, 
                Object [] fila={this.getEnfermedad(), BtnModificar, this.getApyn(), this.getFechaSql()};
                //Object [] fila={1,2,3,4 };
