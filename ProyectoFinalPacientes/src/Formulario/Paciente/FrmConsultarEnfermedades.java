...
public class FrmConsultarEnfermedades extends javax.swing.JFrame {
    ...
    TablaDetallada td = new TablaDetallada();
    private int dniPaciente;
    private int legajo;
    private String especialidad;
    private java.sql.Date sqlFecha;
    
    public FrmConsultarEnfermedades(int doc, int leg, String esp) {
        initComponents();
        dniPaciente=doc;
        legajo=leg;
        especialidad = esp;
    ...
    private void initComponents() {
        ...
        SpHistoriaClinica.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                SpHistoriaClinicaMouseClicked(evt);
            }
        });
        ...
        JpPpalLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, JpPpalLayout.createSequentialGroup()
                ...
                .addGroup(JpPpalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(SpHistoriaClinica, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, JpPpalLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
       ...
       int column = JtHistoria.getColumnModel().getColumnIndexAtX(evt.getX()); //posicion X donde hago clic
        ...
        if (row < JtHistoria.getRowCount() && row >= 0 && column < JtHistoria.getColumnCount() && column >= 0) {
            ...
            if (value instanceof JButton) {  //si la coordenada es un boton
               ...
               String enfermedad = JtHistoria.getValueAt(filita, 0).toString();
                //System.out.println("legajo: " + legajo); 
               //System.out.println("enfermedad: " + enfermedad);
               SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
                try {
                    // sqlFecha 
                    //System.out.println(formato.parse(JtHistoria.getValueAt(filita, 3).toString()));
                     Date fecha = formato.parse(JtHistoria.getValueAt(filita, 3).toString());
                     sqlFecha= ConvertirASql(fecha);
                     //System.out.println("fechA: " + sqlFecha);
                } catch (ParseException ex) {
                    Logger.getLogger(FrmConsultarEnfermedades.class.getName()).log(Level.SEVERE, null, ex);
                }
              

                FrmEnfermedadParticular c = new FrmEnfermedadParticular(legajo,dniPaciente, enfermedad, sqlFecha, especialidad);
                c.setVisible(true);
                this.dispose();
            }
        }
    ...
    private void BtnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAtrasActionPerformed
        ...
        FrmHistoriaClinica hist = new FrmHistoriaClinica(dniPaciente);       
     ...
     private java.sql.Date ConvertirASql(java.util.Date FechaDelFormulario)  
   {
    ...
    private void SpHistoriaClinicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SpHistoriaClinicaMouseClicked
    ...
    }//GEN-LAST:event_SpHistoriaClinicaMouseClicked
   
    private void jTextField1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField1MouseClicked
        final int formularioConsultarHistoriaClinica = 501;
        SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
        try {
            Date fecha = formato.parse("2020-10-10");
            java.sql.Date sqlFecha2 = ConvertirASql(fecha);
             FrmRegistrar reg = new FrmRegistrar(formularioConsultarHistoriaClinica, dniPaciente, legajo, especialidad, "c", sqlFecha2);
        reg.setVisible(true);
        this.dispose();
        } catch (ParseException ex) {
            Logger.getLogger(FrmConsultarEnfermedades.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void DatosComunes() {
        ...
        if (logica.ConsultarPaciente(dniPaciente)) {
            ...
            td.ver_tabla(JtHistoria, logica.getLegajo(), especialidad);
        }
